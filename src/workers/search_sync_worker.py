...
class SearchSyncWorker(BaseWorker):
    ...
    def _index_video(self, asset: Asset, index_name: str) -> int:
        ...
        for scene in scenes:
            ...
            mm = asset.media_metadata or {}
            doc = {
                "id": f"scene_{scene.id}",
                "scene_id": scene.id,
                "asset_id": asset.id,
                "library_slug": asset.library_id,
                "capture_ts": mm.get("capture_ts"),
                "country": mm.get("country"),
                "region": mm.get("region"),
                "city": mm.get("city"),
                "camera_make": mm.get("camera_make"),
                "camera_model": mm.get("camera_model"),
                "color_space": mm.get("color_space"),
                "generation_hint": mm.get("generation_hint"),
                "resolution_w": mm.get("resolution_w"),
                "resolution_h": mm.get("resolution_h"),
                "duration_sec": mm.get("duration_sec"),
                "frame_rate": mm.get("frame_rate"),
                "has_face": mm.get("has_face"),
                "sharpness_score": mm.get("sharpness_score"),
